...
let currentInputDisplay = document.getElementById("currentInput");
let latestResultDisplay = document.getElementById("latestResult");

//add input anropas vid ett knapptryck och lägger till värdet från vald knapp till input
...
function calculate() {
  ...
  try {
    ...
    alert("Calculation failed", JSON.stringify(e));
  }
